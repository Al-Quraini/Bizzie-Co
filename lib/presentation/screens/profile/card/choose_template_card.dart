...
class ChooseTemplateCard extends StatelessWidget {
  static const String id = '/add_new_card_page';
  const ChooseTemplateCard({Key? key}) : super(key: key);
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            SafeArea(
              child: Row(
                ...
                children: [
                  ...
                  const Spacer(),
                  AutoSizeText('Choose a Template',
                      maxLines: 1,
                      minFontSize: 14,
            ...
            InkWell(
              onTap: () {
                Navigator.pop(context, CardTemplate.regular);
              },
              child: Container(
            ...
            InkWell(
              onTap: () {
                Navigator.pop(context, CardTemplate.horizontalHalf);
              },
              child: Container(
                clipBehavior: Clip.antiAlias,
                margin: const EdgeInsets.symmetric(horizontal: 20),
            ...
            InkWell(
              onTap: () {
                Navigator.pop(context, CardTemplate.verticalHalf);
              },
              child: Container(
                clipBehavior: Clip.antiAlias,
                margin: const EdgeInsets.symmetric(horizontal: 20),
